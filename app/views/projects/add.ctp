...
echo "<div class='input select'>";
	...
	echo $form->select('Client.id', $clients, $cookclient, array('id' => 'clients'));
echo "</div>";

echo "<div class='input select'>";
	echo $form->label('Contact', null, array('for' => 'clients'));
	echo $form->select('Contact.id', $options, null, array('id' => 'contacts')); 
echo "</div>";
// Ajax Part 
...
<?php // echo $form->input('client_id', array('selected' => 3, 'onchange' => 'window.alert(\'Change!\')')); ?>	
...
<?php echo $form->input('CreatedDate', array('type' => 'hidden', 'value'=>date("Y-m-d H:i:s"))); ?>
...
<?php echo $form->input('facturation_id', array('selected' => 8)); ?> 
...
<?php echo $form->input('employe_id', array('selected' => $cookempl)); ?>	
<?php echo $form->input('statut_id', array('selected' => 1)); ?>		
